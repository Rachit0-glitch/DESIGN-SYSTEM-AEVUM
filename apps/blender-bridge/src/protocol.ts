...
export const BlenderOperationSchema = z.discriminatedUnion("kind", [
  ...
  z.strictObject({
    ...BaseOperationShape,
    kind: z.literal("pose.inspect"),
    objectId: TargetIdSchema,
    meshObjectId: TargetIdSchema.optional(),
  }),
  z.strictObject({
    ...BaseOperationShape,
    kind: z.literal("pose.update"),
    objectId: TargetIdSchema,
    meshObjectId: TargetIdSchema.optional(),
  ...
  z.strictObject({
    ...BaseOperationShape,
    ...MeshTargetShape,
    kind: z.literal("skin.weight_update"),
    boneKey: z.string().min(1).max(128),
  ...
  z.strictObject({
    ...BaseOperationShape,
    ...MeshTargetShape,
    kind: z.literal("skin.weight_normalize"),
